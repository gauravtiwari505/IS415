...
var admDivID = "FIPS_CNTRY"; //fips
var admDivName = "i_CNTRY_NA"; //country
...
$(document).ready(function(){
    ...
    function updateCountryMap(){
        $('#counties path').click(function () {
            ...
            var fips = this.id.toString().slice(1);
            
            // Ensure that the equivalent value is the same as the default specified in the css or elsewhere
            if(!(d3.select('#b'+fips).attr('class')=="boxplotPoints selected") ||
                !(d3.select('#s'+fips).attr('class')=="scatterplotPoints selected")){
                $(this).css({
                ...
                d3.select('#s'+fips).classed("selected",true);
                d3.select('#b'+fips).classed("selected",true);
                ...
                d3.select("#scatterplotPlot").classed("selecting",true);
                d3.select("#boxplotPlot").classed("selecting",true);
                d3.select('#s'+fips).classed("selected",false);
                d3.select('#b'+fips).classed("selected",false);
                //d3.select('#l'+fips).style("stroke","").style("stroke-width","");
