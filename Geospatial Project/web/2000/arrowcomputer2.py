...
def create_country_json(country_code,matrix,ccode_to_coordinates,file_prefix="in"):
    ...
    f = open('generated_2000/'+file_prefix+country_code+".json","w")
    print '/generated_2000/'+file_prefix+country_code+".json"
    f.write(json.dumps(res))
    f.close()


geoloc_data = json.loads(open('geoloc_2000.json').read())
...
f = open("code_to_coordinates_2000.json",'w')
